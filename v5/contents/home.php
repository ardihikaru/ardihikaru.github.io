                    ...
                    <div id="non-skrollr">
                        ...
                        <div class="container-fluid">
                            <div class="mast">
                                ...
                                <a target="_blank" href="http://github.com/naveenshaji/material" class="cyan darken-2 white-text text-darken-3 waves-effect waves-light btn"><i class="mdi-action-get-app"></i> View on github</a><br>
                                <i class="mdi-navigation-arrow-drop-down" style="font-size: 200px;"></i>
                            </div>
                        </div>


                        <div class="section scrollspy" id="home">
